...
{
  public partial class MasterDestinationDataGrid
  {
    #region Service
    ...
    {
    var res = await IFINTEMPLATEClient.GetRows<JsonObject>("MasterDestination", "GetRows", new 
    { 
        args.Keyword, 
        args.Offset, 
        args.Limit 
    ...
    private void Add()
    {
        NavigationManager.NavigateTo($"setting/destination/add");
    }
    #endregion
    ...
    private async Task Delete()
    {
      ...
      if (userConfirm == true)
      {
        ...
        await IFINTEMPLATEClient.Delete("MasterDestination", "DeleteByID", idList);
