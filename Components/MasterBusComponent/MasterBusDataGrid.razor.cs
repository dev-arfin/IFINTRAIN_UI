...
{
  public partial class MasterBusDataGrid
  {
    #region Service
    ...
    {
    var res = await IFINTEMPLATEClient.GetRows<JsonObject>("MasterBus", "GetRows", new 
    { 
        args.Keyword, 
        args.Offset, 
        args.Limit 
    ...
    private void Add()
    {
        NavigationManager.NavigateTo($"setting/bus/add");
    }
    #endregion
    ...
    private async Task Delete()
    {
      ...
      if (userConfirm == true)
      {
        ...
        await IFINTEMPLATEClient.Delete("MasterBus", "DeleteByID", idList);
