...
{
  public partial class TransactionTicketSellDataGrid
  {
    #region Service
    ...
    {
    var res = await IFINTEMPLATEClient.GetRows<JsonObject>("TransactionTicketSell", "GetRows", new 
    { 
        args.Keyword, 
        args.Offset, 
        args.Limit 
    ...
    private void Add()
    {
        NavigationManager.NavigateTo($"borrowtransaction/transactionticket/add");
    }
    #endregion
    ...
    private async Task Delete()
    {
      ...
      if (userConfirm == true)
      {
        ...
        await IFINTEMPLATEClient.Delete("TransactionTicketSell", "DeleteByID", idList);
